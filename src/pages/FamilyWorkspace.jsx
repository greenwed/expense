  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-24 lg:pb-8">
      ...
      <div className="flex items-center justify-between gap-3 bg-white dark:bg-[#131926] p-3.5 sm:p-4 rounded-3xl border border-slate-200/80 dark:border-slate-700/80 shadow-sm transition-colors">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              >
                <span className="truncate">{currentGroup?.name || 'Family Hub'}</span>
        ...
        {/* Group Actions: New Group & Settings (duplicate Invite and Settings buttons removed) */}
        <div className="flex items-center gap-2 shrink-0">
          ...
          >
            ...
            <span className="hidden xs:inline sm:inline">New Group</span>
          </button>
          <button
            type="button"

...
// Optional Capacitor status bar import for native app
let StatusBar = null;
let Style = null;
try {
  const capStatusBar = require('@capacitor/status-bar');
  StatusBar = capStatusBar.StatusBar;
  Style = capStatusBar.Style;
} catch (e) {}
